...
import com.ttb.broderick.adapter.ListViewAdapter;
...
public class FreshActivity extends AppCompatActivity {
	...
	private void setListnrer() {
		...
		/*testListView.addOnItemTouchListener(new OnItemClickListner(testListView) {
			@Override
			public void onItemClick(RecyclerView.ViewHolder viewHolder, int position) {
				Toast.makeText(FreshActivity.this, "点击了" + position, Toast.LENGTH_SHORT).show();
			}
		});*/
	}
	...
	private void getView(List<String> list) {
		testListView.setAdapter(new ListViewAdapter(FreshActivity.this, list));
	}
}
